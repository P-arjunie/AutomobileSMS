        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <nav className="ml-6 space-x-4">
              <Link to="/employee/dashboard" className="text-sm text-gray-700 hover:text-primary-blue">Dashboard</Link>
              <Link to="/employee/my-work" className="text-sm text-gray-700 hover:text-primary-blue">My Work</Link>
              <Link to="/employee/time-logging" className="text-sm text-gray-700 hover:text-primary-blue">Time Logging</Link>
